...
2. Configure as credenciais de conexão no arquivo `src/main/java/br/uniplan/java_banco_acme/util/ConexaoMySQL.java`:
...
3. Execute a classe `TelaPrincipal` localizada em `src/main/java/br/uniplan/java_banco_acme/view/TelaPrincipal.java`
...
```
src/main/java/br/uniplan/java_banco_acme/
